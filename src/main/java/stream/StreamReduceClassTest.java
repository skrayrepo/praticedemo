...
public class StreamReduceClassTest {
    public static void main(String[] args){
        ...
        Integer reduce2 = list.stream().reduce(0, (a, b) -> a > b ? a : b);
        System.out.println("Largest number="+reduce2);
        Integer reduce3 = list.stream().min(Integer::compare).get();
        System.out.println("Smallest number="+reduce3);
        Integer reduce4 = list.stream().max(Integer::compare).get();
