...
public class PrintNumbers extends RecursiveAction {

        private List<Integer> nums;

        public PrintNumbers(List<Integer> nums) {
            this.nums = nums;
        }
        ...
        protected void compute() {
            ...
            if(nums.size() < 2) {
                ...
                PrintNumbers action1 = new PrintNumbers(left);
                PrintNumbers action2 = new PrintNumbers(right);
